...
func main() {
	...
	assignmentService := service.NewAssignmentService(assignmentRepo, ticketRepo)
	tripService := service.NewTripService(tripRepo, ticketRepo)
	appealService := service.NewAppealService(appealRepo, tripRepo, ticketRepo)
